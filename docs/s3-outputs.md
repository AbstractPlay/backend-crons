...
| `gamemove-layout/analytics/_state.json` | `records-layout-feedback-analytics` | Watermark and dedupe state |
| `gamemove-layout/analytics/daily/YYYY-MM-DD.json` | `records-layout-feedback-analytics` | UTC daily layout feedback rollups (includes note text) |
| `gamemove-layout/analytics/summary.json` | `records-layout-feedback-analytics` | Latest window + rolling 7d/30d + recentNotes |
| `gamemove-layout/analytics/report/YYYY-MM-DD.md` | `records-layout-feedback-analytics` | Human-readable layout feedback report |
